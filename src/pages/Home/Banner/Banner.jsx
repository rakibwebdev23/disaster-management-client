import banner1 from "../../../assets/banner/baner1.jpg";
const Banner = () => {
    return (
        <div className="hero min-h-screen"
            ...
            <div className="hero-content text-neutral-content text-center">
                <div className="max-w-xl">
                    <h1 className="mb-5 lg:text-4xl font-medium text-center">Together for a Safer Bangladesh: Helping People in Times of Disaster!</h1>
                    <div className="">
