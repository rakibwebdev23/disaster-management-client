                ...
                <div className="flex flex-col lg:flex-row items-center gap-8">
                    ...
                    <div className="w-full lg:w-1/2 order-1 lg:order-2">
                        <div className="relative">
                            ...
                            />
                            <div className="absolute -bottom-6 -right-6 bg-teal-600 text-white p-4 md:p-6 rounded-lg shadow-md hidden md:block">
                    ...
                    <div className="w-full lg:w-1/2 order-2 lg:order-1 mt-8 lg:mt-0">
                        ...
                        <div className="space-y-6 mb-8">
                            <div className="bg-white p-4 rounded-lg shadow-sm flex gap-4 hover:shadow-md transition">
                                <div className="bg-teal-100 text-teal-600 h-12 w-12 rounded-full flex items-center justify-center flex-shrink-0">
                        ...
                        <button className="bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-3 rounded-full font-medium shadow-md transition flex items-center gap-2">
                            Donate Now
